...
def get_correction(user_var, pwd_var):
    ...
    corrs = soup.find_all('tr', attrs={'valign': "top", 'bgcolor': "#F7F3FF"})

    for corr in corrs:
        item = corr.find_all('td')
        # print len(attrs)
        d1.append(item[0].get_text().strip())
        d2.append(item[1].get_text().strip())
        d3.append(item[2].get_text().strip())
        d4.append(item[3].get_text().strip())
        d5.append(item[4].get_text().strip())
        d6.append(item[5].get_text().strip())
        d7.append(item[6].get_text().strip())
        d8.append(item[7].get_text().strip())
        d9.append(item[8].get_text().strip())
